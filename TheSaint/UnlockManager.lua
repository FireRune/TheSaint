...
local function fillUnlocksTableAndMap()
	...
	-- "Tesla Coil" (Greedier Mode with Saint)
	createUnlock("Saint", enums.CompletionMarks.GREED_MODE, "hard", "collectible", enums.CollectibleType.COLLECTIBLE_TESLA_COIL)
	-- "Sacred Blindfold" (Delirium with Saint)
	createUnlock("Saint", enums.CompletionMarks.DELIRIUM, "normal", "collectible", enums.CollectibleType.COLLECTIBLE_SACRED_BLINDFOLD)
	-- "Holy Penny" (Mother with Saint)
	createUnlock("Saint", enums.CompletionMarks.MOTHER, "normal", "trinket", enums.TrinketType.TRINKET_HOLY_PENNY)
	...
	-- "Charon's Obol" (Satan + Isaac + The Lamb + ??? with T.Saint)
	...
	-- "Old Hive" (Mother with T.Saint)
	createUnlock("T_Saint", enums.CompletionMarks.MOTHER, "normal", "trinket", enums.TrinketType.TRINKET_OLD_HIVE)
	...
	-- "Sinful Chest" (Mega Satan with T.Saint)
